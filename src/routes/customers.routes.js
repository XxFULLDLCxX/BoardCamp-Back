...
import { createCustomers, readCustomers, readCustomersById, updateCustomersById } from "../controllers/customers.controllers.js";

export const customers_routes = Router();
customers_routes.post('/customers', validateSchema(customers_schema), createCustomers);
customers_routes.get('/customers', readCustomers);
